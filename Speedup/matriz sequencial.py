...
total_elapsed_time_min_max = total_elapsed_time - max_elapsed_time - min_elapsed_time
...
print(f"Soma dos tempos de execução sem Min e Max: {total_elapsed_time_min_max} segundos")
